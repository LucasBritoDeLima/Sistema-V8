...
public class FrmOS extends javax.swing.JFrame {
    ...
    public void getSum() {
        double sum = 0;
        for (double i = 0; i < tabelaOServico.getRowCount(); i++) {
            sum = sum + Double.parseDouble(tabelaOServico.getValueAt((int) i, 3).toString());
        }
    ...
    public void getSumProducts() {
        double sum = 0;
        for (double i = 0; i < tabelaOSPeca.getRowCount(); i++) {
            sum = sum + Double.parseDouble(tabelaOSPeca.getValueAt((int) i, 2).toString());
        }
    ...
    public FrmOS() {
        ...
        this.tabelaOServico.setModel(this.tableModel);
        this.tabelaOSPeca.setModel(this.tableModel2);
        ...
        try {
            String sql = "SELECT COUNT(id) from `tb_ordemdeservico`";
            PreparedStatement stmt = con.prepareStatement(sql);
            ResultSet rs = stmt.executeQuery(sql);
            if (rs.next()) {
                String sum = rs.getString("count(id)");
                int numero_nota = Integer.parseInt(sum) + 1;
                lblOS.setText(String.valueOf(numero_nota));
            }
    ...
    private void initComponents() {
        ...
        tabelaOServico = new javax.swing.JTable();
        ...
        tabelaOSPeca = new javax.swing.JTable();
        ...
        jLabel31.setText("Número da O.S.:");

        lblOS.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        lblOS.setForeground(new java.awt.Color(255, 0, 0));
        lblOS.setText("0");

        txtIdOs.setText("id os");
            ...
            .addGroup(jPanel11Layout.createSequentialGroup()
                ...
                .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel11Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(lblOS, javax.swing.GroupLayout.PREFERRED_SIZE, 152, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel11Layout.createSequentialGroup()
                        .addComponent(jLabel17)
                        .addGap(18, 18, 18)
                        .addComponent(txtData, javax.swing.GroupLayout.PREFERRED_SIZE, 125, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtIdOs, javax.swing.GroupLayout.PREFERRED_SIZE, 53, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        txtPrecoS.setText("0");
        txtPrecoS.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtPrecoSActionPerformed(evt);
            }
        });
        ...
        tabelaOServico.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tabelaOServico.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        tabelaOServico.getTableHeader().setReorderingAllowed(false);
        jScrollPane3.setViewportView(tabelaOServico);
        if (tabelaOServico.getColumnModel().getColumnCount() > 0) {
            tabelaOServico.getColumnModel().getColumn(4).setMinWidth(0);
            tabelaOServico.getColumnModel().getColumn(4).setPreferredWidth(0);
            tabelaOServico.getColumnModel().getColumn(4).setMaxWidth(0);
        }
        ...
        tabelaOSPeca.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane5.setViewportView(tabelaOSPeca);
        if (tabelaOSPeca.getColumnModel().getColumnCount() > 0) {
            tabelaOSPeca.getColumnModel().getColumn(3).setMinWidth(0);
            tabelaOSPeca.getColumnModel().getColumn(3).setPreferredWidth(0);
            tabelaOSPeca.getColumnModel().getColumn(3).setMaxWidth(0);
        }
        ...
        jLabel32.setText("Ao concluir sua ordem de serviço clique no botão emitir");
        ...
        btnEmitir.setText("Emitir ordem de serviço");
        ...
        btnEditar.setText("Editar ordem de serviço");
        ...
        jPanel19Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel19Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel32, javax.swing.GroupLayout.DEFAULT_SIZE, 723, Short.MAX_VALUE)
                .addContainerGap())
    ...
    private void btnRemoverServicosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverServicosActionPerformed
        ...
        double qt = Double.parseDouble(tabelaOServico.getValueAt(tabelaOServico.getSelectedRow(), 0).toString());
        String desc = tabelaOServico.getValueAt(tabelaOServico.getSelectedRow(), 1).toString();
        String cat = tabelaOServico.getValueAt(tabelaOServico.getSelectedRow(), 2).toString();
        double total = Double.parseDouble(tabelaOServico.getValueAt(tabelaOServico.getSelectedRow(), 3).toString());
        int id = Integer.parseInt(tabelaOServico.getValueAt(tabelaOServico.getSelectedRow(), 4).toString());
        double pu = Double.parseDouble(tabelaOServico.getValueAt(tabelaOServico.getSelectedRow(), 5).toString());
        ...
        if (tabelaOServico.getSelectedRow() >= 0) {
            this.tableModel.removePessoa(this.tabelaOServico.getSelectedRow());
        } else {
    ...
    private void btnAlterarPecasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarPecasActionPerformed
        // Botão remover item
        // RECEBER OS DADOS DA TABELA
        double quantidade = Double.parseDouble(tabelaOSPeca.getValueAt(tabelaOSPeca.getSelectedRow(), 0).toString());
        String descricao = tabelaOSPeca.getValueAt(tabelaOSPeca.getSelectedRow(), 1).toString();
        double total = Double.parseDouble(tabelaOSPeca.getValueAt(tabelaOSPeca.getSelectedRow(), 2).toString());
        int id = Integer.parseInt(tabelaOSPeca.getValueAt(tabelaOSPeca.getSelectedRow(), 3).toString());
        double precoUnitario = Double.parseDouble(tabelaOSPeca.getValueAt(tabelaOSPeca.getSelectedRow(), 4).toString());
        // CRIAÇÃO DO OBJETO QUE IRÁ RECEBER O SERVIÇO A SER REMOVIDO
        // RECUPERAR OS DADOS EM FORMA DE OBJETO SELECIONADO DA TABELA
        ...
        if (tabelaOSPeca.getSelectedRow() >= 0) {
            this.tableModel2.removePessoa(this.tabelaOSPeca.getSelectedRow());
        } else {
            JOptionPane.showMessageDialog(null, "Por favor selecione uma linha");
        }
    ...
    private void btnEmitirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEmitirActionPerformed
        // Botão emitir ordem de serviço
        int con = JOptionPane.showConfirmDialog(null, "Deseja emitir a ordem de serviço?"); // se o valor de con for 0, quer dizer que o usuário clicou em sim
        if (con == 0) {
            if (txtID.getText().isEmpty() || txtTotalPecas.getText().isEmpty() || txtTMaoObra.getText().isEmpty() || txtMateriais.getText().isEmpty()) {
                ...
                dao.emitirOrdemDeServico(os);

                // Vinculação de peças a os
                for (int i = 0; i < tabelaOSPeca.getRowCount(); i++) {
                    int ordemservico = Integer.parseInt(lblOS.getText());
                    int pecas = Integer.parseInt(tabelaOSPeca.getValueAt(i, 3).toString());
                    double quantidade = Double.parseDouble(tabelaOSPeca.getValueAt(i, 0).toString());
                    double precounitario = Double.parseDouble(tabelaOSPeca.getValueAt(i, 4).toString());
                    dao.vincularPecas(ordemservico, pecas, quantidade, precounitario);
                }
                // Vinculação de mão de obra a ordem de servico
                for (int p = 0; p < tabelaOServico.getRowCount(); p++) {
                    int ordemservico = Integer.parseInt(lblOS.getText());
                    int maodeobra = Integer.parseInt(tabelaOServico.getValueAt(p, 4).toString());
                    double quantidade = Double.parseDouble(tabelaOServico.getValueAt(p, 0).toString());
                    double precoUnitario = Double.parseDouble(tabelaOServico.getValueAt(p, 5).toString());
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (con == 0) {
            if (txtID.getText().isEmpty() || txtTotalPecas.getText().isEmpty() || txtTMaoObra.getText().isEmpty() || txtMateriais.getText().isEmpty()) {
                ...
                OrdemServico os = new OrdemServico();
                os.setId(Integer.parseInt(lblOS.getText()));
                os.setObservacoes(txtObs.getText());
                os.setCliente(Integer.parseInt(txtID.getText()));
                os.setTotal_pecas(Double.parseDouble(txtTotalPecas.getText()));
                os.setTotal_maodeobra(Double.parseDouble(txtTMaoObra.getText()));
                ...
                os.setTb_motor_idMotor(Integer.parseInt(txtIDM.getText()));
                OrdemServicoDAO dao = new OrdemServicoDAO();
                dao.editarOrdemDeServico(os);
                dao.temPeca(Integer.parseInt(lblOS.getText()));
                dao.temServico(Integer.parseInt(lblOS.getText()));
                // Vinculação de peças a os

                if (tabelaOSPeca.getRowCount() == 0) {
                    dao.temPeca(Integer.parseInt(lblOS.getText()));
                } else if (tabelaOSPeca.getRowCount() >= 1) {
                    for (int i = 0; i < tabelaOSPeca.getRowCount(); i++) {
                        int ordemservico = Integer.parseInt(lblOS.getText());
                        int pecas = Integer.parseInt(tabelaOSPeca.getValueAt(i, 3).toString());
                        double quantidade = Double.parseDouble(tabelaOSPeca.getValueAt(i, 0).toString());
                ...
                // Vinculação de mão de obra a ordem de servico
                if (tabelaOServico.getRowCount() == 0) {
                    dao.temServico(Integer.parseInt(lblOS.getText()));
                } else if (tabelaOServico.getRowCount() >= 1) {
                    for (int p = 0; p < tabelaOServico.getRowCount(); p++) {
                        int ordemservico = Integer.parseInt(lblOS.getText());
                        int maodeobra = Integer.parseInt(tabelaOServico.getValueAt(p, 4).toString());
                        double quantidade = Double.parseDouble(tabelaOServico.getValueAt(p, 0).toString());
    ...
    private void btnLinhaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLinhaActionPerformed
        // TODO add your handling code here:
        JOptionPane.showMessageDialog(null, "Número de linhas da tabela de produtos " + tabelaOSPeca.getRowCount());
        JOptionPane.showMessageDialog(null, "Número de linhas da tabela de mão de obra " + tabelaOServico.getRowCount());
    ...
    private void txtPrecoSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtPrecoSActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtPrecoSActionPerformed
    ...
    public javax.swing.JLabel lblOS;
    private javax.swing.JLabel lblSubTotal;
    private javax.swing.JLabel lblSubTotalPeca;
    private javax.swing.JTable tabelaMotor;
    public javax.swing.JTable tabelaOSPeca;
    public javax.swing.JTable tabelaOServico;
