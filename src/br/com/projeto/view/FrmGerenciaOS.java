 ...
 * @author LUCAS
 */
public class FrmGerenciaOS extends javax.swing.JFrame {
    ...
    public void listar() throws ParseException {
        ...
        List<OrdemServico> lista = dao.listaOS();
        DefaultTableModel dados = (DefaultTableModel) tabelaOrdem.getModel();
        dados.setNumRows(0);
    ...
    public void listarPorCpf() throws ParseException {
        OrdemServicoDAO dao = new OrdemServicoDAO();
        List<OrdemServico> lista = dao.listaOSByCpf("%" + txtCnpj.getText() + "%");
        DefaultTableModel dados = (DefaultTableModel) tabelaOrdem.getModel();
        dados.setNumRows(0);
    ...
    public void listarPorCnpj() throws ParseException {
        OrdemServicoDAO dao = new OrdemServicoDAO();
        List<OrdemServico> lista = dao.listaOSByCpf("%" + txtCpf.getText() + "%");
        DefaultTableModel dados = (DefaultTableModel) tabelaOrdem.getModel();
        dados.setNumRows(0);
    ...
    public void listarPorNome() throws ParseException {
        OrdemServicoDAO dao = new OrdemServicoDAO();
        List<OrdemServico> lista = dao.listaOSByNome("%" + txtNome.getText() + "%");
        DefaultTableModel dados = (DefaultTableModel) tabelaOrdem.getModel();
        dados.setNumRows(0);
    ...
    public void listarPorValor() throws ParseException {
        OrdemServicoDAO dao = new OrdemServicoDAO();
        List<OrdemServico> lista = dao.listaOSByValor(Double.parseDouble(txtValor.getText()));
        DefaultTableModel dados = (DefaultTableModel) tabelaOrdem.getModel();
        dados.setNumRows(0);
    ...
    private void imprimirOs() {
        ...
        if (confirma == JOptionPane.YES_OPTION) {
            ...
            try {
                ...
                filtro.put("id", Integer.parseInt(tabelaOrdem.getValueAt(tabelaOrdem.getSelectedRow(), 5).toString()));
                //Usando a classe jasperprint para preparar a impressão de um relatório
                JasperPrint print = JasperFillManager.fillReport("C:\\Program Files (x86)\\Sistema V8\\reports\\ordemServico.jasper", filtro, con);
                //a linha abaixo exibe o relatório através do jasperviewer
                //JasperViewer.viewReport(print, false);
                JasperViewer view = new JasperViewer(print, false);
                view.setTitle("Visualizar Ordem de Serviço");
                ...
                JOptionPane.showMessageDialog(null, "Exceção de impressão");
                System.out.println(e);
            }
        }
    }

    public FrmGerenciaOS() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Gerenciar Ordem de Serviço");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Procurar Ordem de Serviço", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 12))); // NOI18N
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Ordens de serviço encontradas", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 12))); // NOI18N
        ...
        tabelaOrdem.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nº da OS", "Data", "Nome", "CPF/CNPJ", "Total", "id"
            }
        ));
        tabelaOrdem.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                tabelaOrdemFocusGained(evt);
            }
        });
        tabelaOrdem.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tabelaOrdemMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tabelaOrdem);
        if (tabelaOrdem.getColumnModel().getColumnCount() > 0) {
            tabelaOrdem.getColumnModel().getColumn(0).setMinWidth(70);
            tabelaOrdem.getColumnModel().getColumn(0).setMaxWidth(70);
            tabelaOrdem.getColumnModel().getColumn(5).setMinWidth(0);
            tabelaOrdem.getColumnModel().getColumn(5).setPreferredWidth(0);
            tabelaOrdem.getColumnModel().getColumn(5).setMaxWidth(0);
        }
        ...
        jPanel4Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {btnDetalhar, btnEditar, jButton5, jButton6});
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        try {
            ...
            Logger.getLogger(FrmGerenciaOS.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            ...
            OrdemServicoDAO dao = new OrdemServicoDAO();
            List<OrdemServico> lista = dao.listarNotasPorPeriodo(dataInicio, dataFim);
    ...
    private void btnDetalharActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetalharActionPerformed
        ...
        FrmDetalhes telad = new FrmDetalhes();
        OrdemServico obj = new OrdemServico();
        OrdemServicoDAO dao = new OrdemServicoDAO();

        int id = Integer.parseInt(tabelaOrdem.getValueAt(tabelaOrdem.getSelectedRow(), 5).toString());
        ...
        try {
            ...
            OrdemServicoDAO dao2 = new OrdemServicoDAO();
            List<OrdemServico> lista = dao2.listarServicosCliente(obj.getId());
            dados.setNumRows(0);
            for (OrdemServico o : lista) {
                dados.addRow(new Object[]{
            ...
            OrdemServicoDAO dao3 = new OrdemServicoDAO();
            List<OrdemServico> lista1 = dao3.listarPecasByCliente(obj.getId());
            dados2.setNumRows(0);
            for (OrdemServico os : lista1) {
    ...
    private void tabelaOrdemFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tabelaOrdemFocusGained
        // TODO add your handling code here:
        txtID.setText(tabelaOrdem.getValueAt(tabelaOrdem.getSelectedRow(), 5).toString());
    }//GEN-LAST:event_tabelaOrdemFocusGained

    private void jScrollPane1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jScrollPane1MouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_jScrollPane1MouseClicked

    private void tabelaOrdemMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaOrdemMouseClicked
        txtID.setText(tabelaOrdem.getValueAt(tabelaOrdem.getSelectedRow(), 5).toString());
    }//GEN-LAST:event_tabelaOrdemMouseClicked

    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        int op = JOptionPane.showConfirmDialog(tabelaOrdem, "ATENÇÃO\nDeseja apagar esta ordem de serviço?");
        if (op == 0) {
            OrdemServicoDAO dao = new OrdemServicoDAO();
            dao.inativarOrdem(Integer.parseInt(tabelaOrdem.getValueAt(tabelaOrdem.getSelectedRow(), 5).toString()));
        }
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (linha == 0) {
            ...
            try {
                ...
                formato.applyPattern("dd/MM/yyyy");
                String dataFormatada = formato.format(data);
                Ordem.lblOS.setText(String.valueOf(obj.getId()));
                Ordem.txtIdOs.setText(String.valueOf(obj.getId()));
                ...
                // Tabela Serviços
                OrdemServicoDAO dao1 = new OrdemServicoDAO();
                List<OrdemServico> lista = dao1.listarServicosCliente(id);
                Ordem.modelo.setNumRows(0);
                for (OrdemServico o : lista) {
                    Ordem.modelo.addRow(new String[]{
                        String.valueOf(Ordem.tabelaOServico.getRowCount() + 1),
                    ...
                    Ordem.tabelaOServico.setModel(Ordem.modelo);
                }
                // Tabela Peças
                OrdemServicoDAO dao2 = new OrdemServicoDAO();
                List<OrdemServico> lista1 = dao2.listarPecasByCliente(id);
                Ordem.modelPecas.setNumRows(0);
                for (OrdemServico os : lista1) {
                    Ordem.modelPecas.addRow(new String[]{
                        String.valueOf(Ordem.tabelaOSPeca.getRowCount() + 1),
                    ...
                    Ordem.tabelaOSPeca.setModel(Ordem.modelPecas);
                }
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        // Botão atualizar
        FrmGerenciaOS tela = new FrmGerenciaOS();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmGerenciaOS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmGerenciaOS().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JTable tabelaOrdem;
